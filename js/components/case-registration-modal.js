    ...
    const modalHTML = `
      ...
      <div class="modal-footer" style="padding: 1rem 1.75rem; background: var(--color-surface); border-top: 1px solid var(--color-border); display: flex; align-items: center; justify-content: space-between;">
        ...
        <div class="flex items-center gap-2">
          ...
          ` : `
            <button type="button" class="btn btn-gold" onclick="CaseRegistrationModal.saveAndIndexForAI()" style="background: linear-gradient(135deg, #C89B3C 0%, #DFB75A 100%); font-weight: 700;">
              ✨ Confirm Review, Save & Index for AI
            </button>
          `}
        </div>
      </div>
